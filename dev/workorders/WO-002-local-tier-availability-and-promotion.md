...
- In `internal/core/swarm.go`:
  ...
  - expose façade helpers for future wire/scheduler use:
...
- Important: Tier sizes need to align with merkle tree branch sizes, this allows for proof consolidation that aligns with the tier boundaries.
